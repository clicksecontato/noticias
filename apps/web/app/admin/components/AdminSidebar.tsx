...
const ADMIN_MENU_ITEMS: AdminMenuItem[] = [
  ...
  { path: "/admin/youtube-shorts", label: "YouTube Shorts", icon: Video, showLabel: true },
  { path: "/admin/fontes", label: "Fontes", icon: Rss, showLabel: true },
  { path: "/admin/reports", label: "Relatórios", icon: BarChart3, showLabel: true },
  { path: "/admin/assuntos", label: "Assuntos", icon: Bookmark, showLabel: true },
  { path: "/admin/tags", label: "Tags", icon: Tag, showLabel: true },
  { path: "/admin/tipos", label: "Tipos", icon: Layers, showLabel: true },
